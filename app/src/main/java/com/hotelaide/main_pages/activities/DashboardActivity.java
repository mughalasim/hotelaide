...
//                startActivity(new Intent(DashboardActivity.this, HomePageCollectionActivity.class)
...
//
//                        DashboardActivity.ViewPagerAdapter viewPageradapter = new DashboardActivity.ViewPagerAdapter(getSupportFragmentManager());
//
